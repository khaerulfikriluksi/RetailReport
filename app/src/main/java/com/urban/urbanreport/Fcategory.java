...
public class Fcategory extends AppCompatActivity {
    ...
    LottieAnimationView cat_animsearch,cat_animnoresult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fcategory);
        ...
        if (cursss.getCount()>0) {
            ...
            cat_animnoresult=(LottieAnimationView) findViewById(R.id.cat_animnoresult);
            cat_animsearch=(LottieAnimationView) findViewById(R.id.cat_animsearch);
            cat_search=(EditText) findViewById(R.id.cat_search);
            ...
            cat_search.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    if (s.length()>0 && s.toString()!=null) {
                        ...
                        ArrayList<String> subcategory1= new ArrayList<>();
                        ...
                        for (int i=0;i < category.size();i++) {
                            if (category.get(i).toLowerCase().contains(s.toString().toLowerCase())) {
                                category1.add(category.get(i));
                                subcategory1.add(subcategory.get(i));
                                achievement1.add(achievement.get(i));
                                sales1.add(sales.get(i));
                                exchange1.add(exchange.get(i));
                            }
                        }
                        adapter = new Category_list_adapter(Fcategory.this,category1,subcategory1,achievement1,sales1,exchange1);
                        cat_listview.setAdapter(adapter);
                    } else {
                        adapter = new Category_list_adapter(Fcategory.this,category,subcategory,achievement,sales,exchange);
                        cat_listview.setAdapter(adapter);
                    }
                }
            ...
            floatingActionButton=(FloatingActionButton) findViewById(R.id.cat_get);
            floatingActionButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Fcategory.this,R.style.AppBottomSheetDialogTheme);
                    View bottomsheetview = LayoutInflater.from(Fcategory.this).inflate(
                    ...
                    //Adapter
                    ArrayAdapter<String> storeadapter = new ArrayAdapter<String>(Fcategory.this,
                            R.layout.cus_dropdown_spiner, store);
                    sls_spin_store.setAdapter(storeadapter);
                    ArrayAdapter<String> brandadapter = new ArrayAdapter<String>(Fcategory.this,
                    ...
                    sls_dateto.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (sls_daily.isChecked()) {
                                ...
                                DatePickerDialog datePickerDialog= new DatePickerDialog(Fcategory.this, new DatePickerDialog.OnDateSetListener() {
                                    @Override
                            ...
                            if (sls_monthly.isChecked()) {
                                ...
                                final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
                                MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(Fcategory.this,
...
//                                String cabang = "in ('" + cb6 + "')";
                                ...
                                Toast.makeText(Fcategory.this, "Tidak ada cabang yang cocok", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(Fcategory.this);
    ...
    private void get() {
        ...
        sales.clear();
        exchange.clear();
        cat_listview.setAdapter(null);
        cat_animnoresult.setVisibility(View.INVISIBLE);
        cat_animsearch.setVisibility(View.VISIBLE);
        Log.v("API",apiurl);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, apiurl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        cat_animsearch.setVisibility(View.INVISIBLE);
                        try {
                            ...
                            if (status==200) {
                                ...
                                for (int position = 0; position < jsonArray.length(); position++) {
                                    ...
                                    subcategory.add(row.getString("sub_category"));
                                ...
                                Toast.makeText(Fcategory.this,message, Toast.LENGTH_LONG).show();
                                cat_animnoresult.setVisibility(View.VISIBLE);
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof NetworkError || error instanceof AuthFailureError || error instanceof NoConnectionError || error instanceof TimeoutError) {
                            cat_animnoresult.setVisibility(View.VISIBLE);
                            Toast.makeText(Fcategory.this,"Lost connect from server", Toast.LENGTH_LONG).show();
                        } else if (error instanceof ServerError) {
                            cat_animnoresult.setVisibility(View.VISIBLE);
                            Toast.makeText(Fcategory.this,"Server not responding", Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Fcategory.this);
...
//            if (err==1) {
//                cat_animnoresult.setVisibility(View.VISIBLE);
//                Toast.makeText(Fcategory.this,"Error", Toast.LENGTH_LONG).show();
//            }
//            if (nodata==1) {
//                cat_animnoresult.setVisibility(View.VISIBLE);
//                Toast.makeText(Fcategory.this,"No Data", Toast.LENGTH_LONG).show();
//            } else {
//                adapter = new Category_list_adapter(Fcategory.this,category,subcategory,achievement,sales,exchange);
//                cat_listview.setAdapter(adapter);
//            }
...
//    }
    ...
    public void onBackPressed() {
        ...
        if (count ==1) {
            ...
            bg=(CoordinatorLayout) findViewById(R.id.cat_parent);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                circularReveal.addListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        Intent formku = new Intent(Fcategory.this, FDashboardMenu.class);
