...
public class UpdateHelper {
    ...
    public void check(){
        if (Cache.getInstance().getBoolData("rest_mode")==false) {
            ...
            myRef.child("app_sales_version").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                @Override
            ...
            int newver = Integer.parseInt(Cache.getInstance().getDataList("AppVersion"));
            currentver();
