...
public class Fpromosi extends AppCompatActivity {
    ...
    EditText pro_search;
    LottieAnimationView pro_animsearch,pro_animnoresult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fpromosi);
        ...
        if (cursss.getCount()>0) {
            ...
            pro_search=(EditText) findViewById(R.id.pro_search);
            pro_listview=(ListView) findViewById(R.id.pro_listview);
            pro_animnoresult=(LottieAnimationView) findViewById(R.id.pro_animnoresult);
            pro_animsearch=(LottieAnimationView) findViewById(R.id.pro_animsearch);
            ...
            pro_search.addTextChangedListener(new TextWatcher() {
                @Override
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    if (s.length()>0 && s.toString()!=null) {
                        ArrayList<String> promosi1=new ArrayList<>();
                        ArrayList<String> achievement1=new ArrayList<>();
                        ArrayList<String> sales1=new ArrayList<>();
                        ArrayList<String> exchange1=new ArrayList<>();
                        for (int i=0;i < promosi.size();i++) {
                            if (promosi.get(i).toLowerCase().contains(s.toString().toLowerCase())) {
                                promosi1.add(promosi.get(i));
                                achievement1.add(achievement.get(i));
                                sales1.add(sales.get(i));
                                exchange1.add(exchange.get(i));
                            }
                        }
                        adapter = new Items_and_promotion_adapter(Fpromosi.this,promosi1,achievement1,sales1,exchange1);
                        pro_listview.setAdapter(adapter);
                    } else {
                        adapter = new Items_and_promotion_adapter(Fpromosi.this,promosi,achievement,sales,exchange);
                        pro_listview.setAdapter(adapter);
                    }
                }
            ...
            floatingActionButton=(FloatingActionButton) findViewById(R.id.pro_get);
            floatingActionButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Fpromosi.this,R.style.AppBottomSheetDialogTheme);
                    View bottomsheetview = LayoutInflater.from(Fpromosi.this).inflate(
                    ...
                    //Adapter
                    ArrayAdapter<String> storeadapter = new ArrayAdapter<String>(Fpromosi.this,
                            R.layout.cus_dropdown_spiner, store);
                    sls_spin_store.setAdapter(storeadapter);
                    ArrayAdapter<String> brandadapter = new ArrayAdapter<String>(Fpromosi.this,
                    ...
                    sls_dateto.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (sls_daily.isChecked()) {
                                ...
                                DatePickerDialog datePickerDialog= new DatePickerDialog(Fpromosi.this, new DatePickerDialog.OnDateSetListener() {
                                    @Override
                            ...
                            if (sls_monthly.isChecked()) {
                                ...
                                final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
                                MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(Fpromosi.this,
...
//                                String cabang = "in ('" + cb6 + "')";
                                ...
                                Toast.makeText(Fpromosi.this, "Tidak ada cabang yang cocok", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(Fpromosi.this);
    ...
    private void get() {
        ...
        sales.clear();
        exchange.clear();
        pro_listview.setAdapter(null);
        pro_animnoresult.setVisibility(View.INVISIBLE);
        pro_animsearch.setVisibility(View.VISIBLE);
        Log.v("API",apiurl);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, apiurl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        pro_animsearch.setVisibility(View.INVISIBLE);
                        try {
                            ...
                            if (status==200) {
                                ...
                                Toast.makeText(Fpromosi.this,message, Toast.LENGTH_LONG).show();
                                pro_animnoresult.setVisibility(View.VISIBLE);
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof NetworkError || error instanceof AuthFailureError || error instanceof NoConnectionError || error instanceof TimeoutError) {
                            pro_animnoresult.setVisibility(View.VISIBLE);
                            Toast.makeText(Fpromosi.this,"Lost connect from server", Toast.LENGTH_LONG).show();
                        } else if (error instanceof ServerError) {
                            pro_animnoresult.setVisibility(View.VISIBLE);
                            Toast.makeText(Fpromosi.this,"Server not responding", Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Fpromosi.this);
    ...
    public void onBackPressed() {
        ...
        if (count ==1) {
            ...
            bg=(CoordinatorLayout) findViewById(R.id.pro_parent);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                circularReveal.addListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        Intent formku = new Intent(Fpromosi.this, FDashboardMenu.class);
